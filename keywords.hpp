...
namespace ECE141 {
  ...
  enum class Keywords {
    ...
    database_kw, databases_kw, datetime_kw, decimal_kw, default_kw, 
    delete_kw, desc_kw, describe_kw, distinct_kw, double_kw, drop_kw,
    dump_kw, enum_kw, explain_kw, false_kw,
    ...
    primary_kw, primary_key_kw, quit_kw, references_kw, right_kw,
